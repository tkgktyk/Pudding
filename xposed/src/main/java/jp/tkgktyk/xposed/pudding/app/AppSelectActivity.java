...
import jp.tkgktyk.xposed.pudding.app.util.IconCache;
...
public class AppSelectActivity extends AppCompatActivity {
    ...
    private static String EXTRA_TITLE = Pudding.PREFIX_EXTRA + "TITLE";
    public static String EXTRA_SELECTED_HASH_SET = Pudding.PREFIX_EXTRA + "SELECTED_HASH_SET";
    ...
    public static class AppSelectFragment extends ListFragment {
        ...
        public void onPause() {
            super.onPause();
            LocalBroadcastManager.getInstance(getActivity())
                    .unregisterReceiver(mIconCachedReceiver);
        }
