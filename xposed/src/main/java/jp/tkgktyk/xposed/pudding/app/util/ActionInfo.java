...
public class ActionInfo {
    ...
    private void fromToolIntent(Context context, @NonNull Intent intent) {
        mIntent = intent;
        mName = Pudding.getActionName(context, intent.getAction());
        mIcon = Utilities.createIconBitmap(BitmapFactory.decodeResource(context.getResources(),
                Pudding.getActionIconResource(intent.getAction())), context);
    }
    ...
    public String getPackageName() {
        if (mIntent != null && mType == TYPE_APP && mIntent.getComponent() != null) {
